...
namespace Magestio\Slider\Block\Adminhtml\Banner\Edit\Tab;
...
use Magestio\Slider\Model\Banner as BannerModel;
use Magestio\Slider\Model\SliderFactory;
use Magestio\Slider\Model\Status;

/**
 * Class Banner
 * @package Magestio\Slider\Block\Adminhtml\Banner\Edit\Tab
 */
class Banner extends Generic implements TabInterface
{
    ...
    protected function _prepareLayout()
    {
        ...
        \Magento\Framework\Data\Form::setFieldsetElementRenderer(
            $this->getLayout()->createBlock(
                'Magestio\Slider\Block\Adminhtml\Form\Renderer\Fieldset\Element',
    ...
    protected function _prepareForm()
    {
        ...
        /**
         * @var \Magestio\Slider\Model\Banner $bannerModel
         */
        ...
        if ($slider->getId()) {
            $elements['slider_id'] = $fieldset->addField(
                ...
                [
                    ...
                    'note'     =>  __('Select to which Slider you wish to assign current banner. The assignments of banner can be done also later from Sliders Manager > Edit or Add New Slider > Slider Banners grid.'),
                ]
            );
        } else {
            $elements['slider_id'] = $fieldset->addField(
        ...
        $elements['url'] = $fieldset->addField(
            ...
            [
                ...
                'name'     => 'url',
                'required' => false,
                'note'    => __('Set the URL where the banner/button should link when clicked on. URL Note 1: set the URL without your store base url, ex. /women.html; URL Note 2: if "Text Button" option is filled, URL will be linked to the button instead of banner.'),
            ]
        );
        ...
        $elements['target'] = $fieldset->addField(
            ...
            [
                ...
                'required' => false,
                'note'    => __('Choose how the URL should be opened: same tab or in a new tab.'),
            ]
        );
        ...
        $elements['banner_type'] = $fieldset->addField(
            ...
            [
                ...
                'required' => false,
                'note'     => __('Choose banner type: Image, Video or Custom. In Custom you can insert HTML content.'),
            ]
        );
        ...
        $elements['image'] = $fieldset->addField(
            ...
            [
                ...
                'label'    => __('Image'),
                'name'     => 'image',
                'note'     => __('Accepted images: jpg, jpeg, gif, png'),
                'required' => false,
            ]
        );
        ...
        $elements['alt_text'] = $fieldset->addField(
            ...
            [
                ...
                'name'     => 'alt_text',
                'required' => false,
                'note'     => __('Specify an alternate text for image in case the image cannot be displayed.'),
            ]
        );
        ...
        if ($bannerModel->getId()) {
            $elements['bannerclass'] = $fieldset->addField(
                ...
                [
                    ...
                    'note' => __('Wrapper class name of the current banner. It can be used in Custom CSS field to style each banner from the slider. This is displayed only after you saved the banner.')
                ]
            );
        }
        ...
        $elements['custom_css'] = $fieldset->addField(
            ...
            [
                ...
                'name'     => 'custom_css',
                'required' => false,
                'note'     => __('Insert your custom CSS style.'),
            ]
        );
        ...
        $elements['valid_from'] = $fieldset->addField(
            ...
            [
                ...
                'note'        => implode(' ', [$dateFormat, $timeFormat]) . __('<br/>The banner is displayed from selected date and time.<br/><b>For schedules to work make sure to enable Ajax Scheduled Banners from Slider Details.</b>'),
            ]
        );
        ...
        $elements['valid_to'] = $fieldset->addField(
            ...
            [
                ...
                'date_format' => $dateFormat,
                'time_format' => $timeFormat,
                'note'        => implode(' ', [$dateFormat, $timeFormat]) . __('<br/>The Banner is displayed until selected date and time.<br/><b>For schedules to work make sure to enable Ajax Scheduled Banners from Slider Details.</b>'),
            ]
        );
     ...
     *
     * @return \Magestio\Slider\Model\Banner
     */
