    ...
    protected function _prepareForm()
    {
        ...
        $elements['scheduled_ajax'] = $fieldset->addField(
            ...
            [
                ...
                'note'    => __('If yes, Ajax Frontend call will be used for Scheduled Banners.'),
            ]
        );
        ...
        $elements['nav'] = $fieldset->addField(
            ...
            [
                ...
                'note'    => __('If Yes, next/prev buttons are displayed. <br/>Slider Responsive Breakpoints options overwrites this option. Please check below Slider Responsive Breakpoints options.'),
            ]
        );
        ...
        $elements['dots'] = $fieldset->addField(
            ...
            [
                ...
                'note'    => __('If Yes, dots navigation are displayed.'),
            ]
        );
        ...
        $elements['transition'] = $fieldset->addField(
            ...
            [
                ...
                'note'     => __('Effect of transition between slides.')
            ]
        );
        ...
        $elements['center'] = $fieldset->addField(
            ...
            [
                'name'     => 'center',
                'label'    => __('Center Slide'),
                'title'    => __('Center Slide'),
                'required' => false,
                'values'   => [
                    ['value' => 1, 'label' => __('Yes')],
                    ['value' => 0, 'label' => __('No')]
                ],
                'note'     => __('Center slide. Works well with even an odd number of slides.')
            ]
        );
        ...
        $elements['margin'] = $fieldset->addField(
            ...
            [
                ...
                'title'    => __('Margin'),
                'required' => false,
                'note'     => __('Set right margin for each item in carousel.'),
            ]
        );
        ...
        $elements['items'] =$fieldset->addField(
            ...
            [
                ...
                'note'     => __('The number of items you want to see on the screen. <br/>Slider Responsive Breakpoints options overwrites this option. Please check below Slider Responsive Breakpoints options.')
            ]
        );
        ...
        $elements['loop'] = $fieldset->addField(
            ...
            [
                ...
                'note'     => __('Infinite loop. Duplicate last and first items to get loop illusion.')
            ]
        );
        ...
        $elements['lazyLoad'] = $fieldset->addField(
            ...
            [
                ...
                'note'      => __('LazyLoad delays loading of images. Images outside of viewport are not loaded until user scrolls to them.')
            ]
        );
        ...
        $elements['autoplayTimeout'] = $fieldset->addField(
            ...
            [
                ...
                'required' => false,
                'note'     => __('Autoplay interval timeout. Insert value in ms. Write “4000” for a 4 seconds timeout')
            ]
        );
        ...
        $elements['autoHeight'] = $fieldset->addField(
            ...
            [
                ...
                'note'    => __('If yes, each banner will adjust height.'),
            ]
        );
        ...
        $elements['nav_brk1'] = $fieldset->addField(
            ...
            [
                ...
                'note'    => __('If Yes, next/prev buttons are displayed.'),
            ]
        );
        ...
        $elements['items_brk1'] = $fieldset->addField(
            ...
            [
                ...
                'required' => true,
                'class'    => 'validate-greater-than-zero',
                'note'     => __('The number of items you want to see at this breakpoint and higher.')
            ]
        );
